              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(height: 50,),
                    ListTile(
                      title: Text("Vikash Choudhary",
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white,),),
                      subtitle: Text("milakhalifa.com",
                    ...
                    menu_item(icon : Icons.home,
                        title : "Homepage",
                        onclick : (){
                          onIconPressed();
                          BlocProvider.of<Navigation_Bloc>(context).add(NavigationEvents.homepage_click);
                        }
                    ),
                    menu_item(icon : Icons.lightbulb_outline,
                        title : "Vegetables",
                      onclick : (){
                            onIconPressed();
                            BlocProvider.of<Navigation_Bloc>(context).add(NavigationEvents.greenvegetable_click);
                      }
                    ),
                    menu_item(
                      ...
                      title : "Raddiwala",
                        onclick : (){
                          onIconPressed();
                          BlocProvider.of<Navigation_Bloc>(context).add(NavigationEvents.raddiwala_click);
                        }
                    ),
                    menu_item(
                      ...
                      title : "Tailor",
                        onclick : (){
                          onIconPressed();
                          BlocProvider.of<Navigation_Bloc>(context).add(NavigationEvents.tailor_click);
                        }
                    ),
                    menu_item(
                      icon : Icons.business,
                      title : "Building Contractor",
                        onclick : (){
                          onIconPressed();
                          BlocProvider.of<Navigation_Bloc>(context).add(NavigationEvents.construction_click);
                        }
                    ),
                    Divider(
                      height: 60,
